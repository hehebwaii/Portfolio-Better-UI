    ...
    <section id="testimonials" className="relative w-full bg-neocream py-32 px-6 flex flex-col items-center scroll-mt-[100px]">
      ...
      >
        <svg 
          ...
          className="drop-shadow-[8px_8px_0px_#000]"
        >
          ...
          <motion.rect 
            ...
            stroke="black" 
            strokeWidth="4"
            animate={{ y: isOpen ? -30 : 0, rotate: isOpen ? 5 : 0 }}
          ...
          <motion.rect 
            ...
            stroke="black" 
            strokeWidth="4"
            animate={{ y: isOpen ? -15 : 0, rotate: isOpen ? -5 : 0 }}
            transition={{ type: "spring", stiffness: 300, damping: 20, delay: 0.05 }}
          />

          <motion.path 
            d="M10 40C10 34.4772 14.4772 30 20 30H140C145.523 30 150 34.4772 150 40V100C150 105.523 145.523 110 140 110H20C14.4772 110 10 105.523 10 100V40Z" 
            fill="#10B981" 
            stroke="black" 
            strokeWidth="4"
            style={{ originY: "110px" }}
            animate={{ rotateX: isOpen ? -20 : 0 }}
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
          />
        </svg>
