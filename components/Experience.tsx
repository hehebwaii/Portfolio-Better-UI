...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={targetRef} className="relative w-full bg-neocream h-[300vh] scroll-mt-[100px]">
      {/* 
        CRITICAL V12.3 STICKY FIX: NAVBAR-AWARE
        This inner div strictly uses `sticky top-[100px] h-[calc(100vh-100px)]` to lock the viewport below the fixed navbar 
        while the parent `<section>` absorbs the 300vh scrolling height. `overflow-hidden` prevents horizontal bleed.
      */}
