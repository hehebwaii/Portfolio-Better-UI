...
export default function Skills({ heading = "WHAT I CAN DO", subheading = "FOR YOU.", skillOverrides = [] }: SkillsProps) {
  const badgeColors = ["bg-neoblue", "bg-neopink", "bg-neoyellow", "bg-neogreen"];
  const Icons = [Cpu, Code, Camera, Video];

  // Merge: Notion overrides take priority per slot; fall back to content.ts defaults
